...
const testimonials = [
  {
    ...
    location: "New York",
    rating: 5,
    text: "The Artisan Tote Bag is so well-made! The stitching is perfect and it holds everything beautifully. This is true artisan quality.",
    product: "Artisan Tote Bag"
  },
  {
    id: 2,
    name: "Emma L.",
    ...
    rating: 5,
    text: "I'm obsessed with my Crux beanie! So soft and cozy. Supporting handmade craftsmanship feels amazing.",
    product: "Cozy Beanie"
  },
  {
    id: 3,
    ...
    location: "Chicago",
    rating: 5,
    text: "The Oversized Scarf is absolutely divine. The stitch pattern is intricate and it's incredibly comfortable to wear.",
    product: "Oversized Scarf"
  },
  {
    id: 4,
    name: "Maria K.",
    location: "Miami",
    rating: 5,
    text: "I've never seen crochet work as beautiful as this. The Shawl Wrap is a masterpiece. Crux nailed it!",
    product: "Shawl Wrap"
  },
  {
    id: 5,
    ...
    location: "Seattle",
    rating: 5,
    text: "The Throw Blanket is exactly what my home needed. Sustainable, beautiful, and incredibly soft. Love supporting ethical makers!",
  ...
  },
  {
    ...
    location: "Boston",
    rating: 5,
    text: "My kids love the Baby Blanket! The quality is incredible and knowing it's handcrafted makes it even more special.",
  ...
  },
  {
    ...
    location: "Austin",
    rating: 5,
    text: "The Boho Crossbody is perfect for everyday use. Beautiful design and so practical. Best purchase ever!",
    product: "Boho Crossbody"
  },
  {
    id: 8,
    name: "Lily W.",
    location: "Portland",
    rating: 5,
    text: "I love that Crux uses sustainable materials. The quality speaks for itself. Every piece is a work of art!",
  ...
  },
  {
    ...
    location: "Denver",
    rating: 5,
    text: "The details on these pieces are incredible. You can tell so much care goes into every stitch. Pure artisan craftsmanship!",
    product: "Wall Hanging Art"
  }
]
