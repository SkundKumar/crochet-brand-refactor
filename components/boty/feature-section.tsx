...
const features = [
  {
    ...
    description: "Eco-friendly organic and recycled materials"
  },
  {
    icon: Leaf,
    title: "Handcrafted",
    description: "Made with artisan techniques and love"
  },
  {
    icon: Flower2,
    title: "Premium Quality",
    description: "Soft, durable, long-lasting pieces"
  },
  {
    icon: Globe,
    title: "Fair Trade",
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xl text-foreground mb-2 font-medium">
                    100% <span className="">Handcrafted</span>
                  </h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Each piece is meticulously created by hand using premium sustainable yarn and traditional crochet techniques.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-white/90 text-sm">
                  ...
                  <span>Premium Yarn Quality</span>
                </div>
                <div className="flex items-center gap-2 text-white/90 text-sm">
        ...
        >
          ...
          >
            ...
            <p className={`text-lg text-muted-foreground leading-relaxed mb-10 max-w-md ${headerVisible ? 'animate-blur-in opacity-0' : 'opacity-0'}`} style={headerVisible ? { animationDelay: '0.6s', animationFillMode: 'forwards' } : {}}>
              We believe in creating timeless crochet pieces that bring beauty, comfort, and artistry into your life. 
              Every stitch is made with intention, care, and passion for quality craftsmanship.
            </p>
